...
const Matchmaking = () => {
  ...
  return (
    <div className="min-h-[70vh] w-full text-[var(--text-primary)] flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans select-none animate-[fadeIn_0.4s_ease-out] transition-colors duration-300">
      ...
      <div className="max-w-md w-full text-center space-y-8 relative z-10">
        ...
        <Card className="p-6 grid grid-cols-2 gap-4 divide-x divide-[var(--border)]">
          <div className="space-y-1">
            <div className="flex items-center justify-center gap-1.5 text-[10px] text-[var(--text-secondary)] font-bold uppercase tracking-wider">
              <Award className="w-3.5 h-3.5" /> Your Rating
            </div>
            <p className="text-2xl font-black text-[var(--text-primary)] font-mono">{myElo}</p>
          </div>
          <div className="space-y-1 pl-4">
            <div className="flex items-center justify-center gap-1.5 text-[10px] text-[var(--text-secondary)] font-bold uppercase tracking-wider">
              <Users className="w-3.5 h-3.5" /> Rating Range
            </div>
        ...
        <motion.button
          ...
          className="w-full px-8 py-3 rounded-xl font-bold flex items-center justify-center gap-2 border transition-all duration-300 group border-border bg-transparent text-danger hover:border-danger/50 hover:bg-danger/5 hover:shadow-[0_0_20px_var(--shadow-glow-red)]"
        >
          Cancel Matchmaking
        </motion.button>
